...
describe('formatBlogPosts - Filtering', () => {
    ...
    const mockPosts = [
      {
        frontmatter: { title: 'Post 1', draft: true, pubDate: '2025-03-15' },
        content: 'Content 1',
        url: '/astro-blog/blog/post1',
      },
    ];
    ...
    const mockPosts = [
      {
        frontmatter: { title: 'Future Post', pubDate: '3025-03-15' },
        content: 'Content',
        url: '/astro-blog/blog/future-post',
      },
    ];
  ...
  const mockPosts = [
      { frontmatter: { pubDate: '2025-03-10' }, content: 'Content 1', url: '/astro-blog/blog/post1' },
      { frontmatter: { pubDate: '2025-03-15' }, content: 'Content 2', url: '/astro-blog/blog/post2' },
  ];
    ...
    it('should throw an error if both sortByNew and sortByOld are true', async () => {
        await expect(async () =>
            formatBlogPosts(mockPosts, { sortByNew: true, sortByOld: true })
...
describe('formatBlogPosts - Pagination', () => {
    it('should return the correct slice of posts based on limit and pageStart', async () => {
      const mockPosts = [
        { frontmatter: { pubDate: '2025-03-10' }, content: 'Content 1', url: '/astro-blog/blog/post1' },
        { frontmatter: { pubDate: '2025-03-12' }, content: 'Content 2', url: '/astro-blog/blog/post2' },
        { frontmatter: { pubDate: '2025-03-15' }, content: 'Content 3', url: '/astro-blog/blog/post3' },
      ];
